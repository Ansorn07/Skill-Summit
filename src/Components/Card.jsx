...
const Card = (props) => {
    ...
    return (
        <div className='bg-bgDark bg-opacity-80 w-[300px] rounded-md overflow-hidden  shadow-xl rounded-xl overflow-hidden m-4 w-72 transform hover:scale-105 transition-transform duration-300 hover:shadow-2xl border border-pink-200'>
